<template>
  ...
  <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g>
      <g>
        <path id="path-2"
          d="M27.05,4.93c-1.27-1.26-3.33-1.26-4.6,0L6.68,20.72c-0.09,0.09-0.17,0.2-0.22,0.32l-2.51,5.69
        ...
        <path fill="#BCBCBC"
          d="M25.16,10c-0.2,0.2-0.42,0.42-0.66,0.67l-2.19-2.19c0.25-0.24,0.471-0.46,0.671-0.67L25.16,10z" />
        <path fill="#BCBCBC"
          d="M23.79,11.37c-0.271,0.27-0.56,0.56-0.86,0.86l-2.18-2.18c0.3-0.3,0.59-0.59,0.86-0.86L23.79,11.37z" />
        <path fill="#FFD561"
          d="M22.23,12.93c-4.04,4.05-9.78,9.79-11.291,11.3L9.76,23.05c1.51-1.51,7.25-7.26,11.29-11.3L22.23,12.93z" />
      </g>
    </g>
  </svg>
</template>